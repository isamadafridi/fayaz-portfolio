  ...
  return (
    <>
      <motion.nav
        ...
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-background/80 backdrop-blur-md py-4 border-b border-border shadow-lg' : 'bg-transparent py-6'
          }`}
      >
        <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
          <a href="#" className="text-2xl font-heading tracking-wider font-bold text-white z-50">
            FAYAZ AFRIDI<span className="text-primary">.</span>
          </a>
